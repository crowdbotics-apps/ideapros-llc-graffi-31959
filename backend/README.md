...
## Project Structure
    ...
    ├── ideapros_llc_graffi_31959  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_graffi_31959`
...
2. Clone this repo and `cd ideapros_llc_graffi_31959`
